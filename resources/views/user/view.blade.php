                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update', ['id' => $user->id]) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control" name="city" value="{{ $user->city }}" autocomplete="city">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="birthdate" type="date" class="form-control" name="birthdate" value="{{ $user->birthdate }}" autocomplete="birthdate">
                            </div>
                        </div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a href="{{ route('home', ['page' => 1]) }}" class="btn btn-danger">
                                    {{ __('Cancel') }}
                                </a>
                            </div>
                        </div>
